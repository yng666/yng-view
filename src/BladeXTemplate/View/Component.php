...
use Closure;
use Yng\Container;
use Yng\View\BladeXTemplate\Contracts\Support\Htmlable;
use Yng\View\BladeXTemplate\Contracts\View\View as ViewContract;
use ReflectionClass;
use ReflectionMethod;
use ReflectionProperty;

use function Yng\View\BladeXTemplate\Support\collect;
use function Yng\View\BladeXTemplate\Support\hash_fit;
...
abstract class Component
{
     ...
     *
     * @var \Yng\View\BladeXTemplate\View\ComponentAttributeBag
     */
    public $attributes;
     ...
     *
     * @var \Yng\View\BladeXTemplate\Contracts\View\Factory|null
     */
     ...
     *
     * @return \Yng\View\BladeXTemplate\Contracts\View\View|\Yng\View\BladeXTemplate\Contracts\Support\Htmlable|\Closure|string
     */
     ...
     * Create a Blade view with the raw component string content.
     *
     * @param  \Yng\View\BladeXTemplate\Contracts\View\Factory  $factory
     * @param  string  $contents
     * @return string
     */
    protected function createBladeViewFromString($factory, $contents)
    {
        ...
        $theme = $config['theme'] ?: '';
        $directory = $config['compiled'] ?: null;
        $compiledExtension = '.html.'. ($config['view.compiledExtension'] ?? 'php');

        unset($config);

        if (is_null($directory)) {
            $directory = Container::getInstance()->getStoragePath() .'framework'. DIRECTORY_SEPARATOR .'components'. DIRECTORY_SEPARATOR;
        }
        ...
        return '__components::'. basename($viewFile, $compiledExtension);
    }
     ...
     *
     * @param  string  $method
     * @return \Yng\View\BladeXTemplate\View\InvokableComponentVariable
     */
     ...
     *
     * @param  array  $attributes
     * @return \Yng\View\BladeXTemplate\View\ComponentAttributeBag
     */
     ...
     *
     * @return \Yng\View\BladeXTemplate\Contracts\View\Factory
     */
    protected function factory()
    {
        if (is_null(static::$factory)) {
            static::$factory = Container::getInstance()->get('blade.view');
        }
