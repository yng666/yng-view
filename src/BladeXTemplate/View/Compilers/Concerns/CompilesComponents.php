...
use Yng\View\BladeXTemplate\View\ComponentAttributeBag;

use function Yng\View\BladeXTemplate\Support\e;
...
trait CompilesComponents
{
    ...
    public static function compileClassComponentOpening(string $component, string $alias, string $data, string $hash)
    {
        return implode("\n", [
            ...
            '<?php $component = '.$component.'::resolve('.($data ?: '[]').' + (isset($attributes) && $attributes instanceof Yng\View\BladeXTemplate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>',
    ...
    {
        return "<?php \$attributes ??= new \\Yng\View\BladeXTemplate\\View\\ComponentAttributeBag; ?>
