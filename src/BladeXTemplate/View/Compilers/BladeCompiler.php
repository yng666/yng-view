...
namespace Yng\View\BladeXTemplate\View\Compilers;

use Yng\Container;
use Yng\View\BladeXTemplate\Contracts\View\View;
use Yng\View\BladeXTemplate\Contracts\View\Factory as ViewFactory;
use Yng\View\BladeXTemplate\Support\Arr;
use Yng\View\BladeXTemplate\Support\Str;
use Yng\View\BladeXTemplate\View\Component;
...
class BladeCompiler extends Compiler implements CompilerInterface
{
     ...
     * @var string
     */
    protected $echoFormat = 'Yng\View\BladeXTemplate\Support\e(%s)';
     ...
     *
     * @param  string  $contents
     * @return \Yng\View\BladeXTemplate\Support\Collection
     */
     ...
     *
     * @param  \Yng\View\BladeXTemplate\View\Component  $component
     * @return string
     */
    ...
    public function if($name, callable $callback)
    {
        ...
        // \Yng\View\BladeXTemplate\Support\Facades\Blade
        // \Yng\blade\facade\Blade

        $this->directive($name, function ($expression) use ($name) {
            return $expression !== ''
                    ? "<?php if (\\Yng\\Blade\\Facade\Blade::check('{$name}', {$expression})): ?>"
                    : "<?php if (\\Yng\\Blade\\Facade\Blade::check('{$name}')): ?>";
        });
        ...
        $this->directive('else'.$name, function ($expression) use ($name) {
            return $expression !== ''
                ? "<?php elseif (\\Yng\\Blade\\Facade\\Blade::check('{$name}', {$expression})): ?>"
                : "<?php elseif (\\Yng\\Blade\\Facade\\Blade::check('{$name}')): ?>";
        });
    ...
    public function anonymousComponentPath(string $path, string $prefix = null)
    {
        ...
        Container::getInstance()->make('blade.view')->addNamespace($prefixHash, $path);
    }
    ...
    public function aliasInclude($path, $alias = null)
    {
        ...
        $this->directive($alias, function ($expression) use ($path) {
            ...
            return "<?php echo \$__env->make('{$path}', {$expression}, \Yng\View\BladeXTemplate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>";
        });
    }
