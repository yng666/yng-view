...
use Yng\Container;
use Yng\View\BladeXTemplate\Contracts\View\Factory;
use Yng\View\BladeXTemplate\Support\Str;
use Yng\View\BladeXTemplate\View\AnonymousComponent;
use Yng\View\BladeXTemplate\View\DynamicComponent;

use Yng\View\BladeXTemplate\View\ViewName;
...
class ComponentTagCompiler
{
     ...
     *
     * @var \Yng\View\BladeXTemplate\View\Compilers\BladeCompiler
     */
    protected $blade;
     ...
     * @param  \Yng\View\BladeXTemplate\View\Compilers\BladeCompiler|null  $blade
     * @return void
     */
...
<?php $component->withAttributes(['.$this->attributesToString($attributes->all(), $escapeAttributes = $class !== DynamicComponent::class).']); ?>';
    ...
    public function componentClass(string $component)
    {
        ...
        // dd($this->guessClassName($component));
     ...
     *
     * @param  \Yng\View\BladeXTemplate\Contracts\View\Factory  $viewFactory
     * @param  string  $component
     * @return string|null
     */
        ...
        return preg_replace_callback(
            '/@(class)(\( ( (?>[^()]+) | (?2) )* \))/x', function ($match) {
                if ($match[1] === 'class') {
                    ...
                    return ":class=\"\Yng\View\BladeXTemplate\Support\Arr::toCssClasses{$match[2]}\"";
                }
        ...
        return preg_replace_callback(
            '/@(style)(\( ( (?>[^()]+) | (?2) )* \))/x', function ($match) {
                if ($match[1] === 'style') {
                    ...
                    return ":style=\"\Yng\View\BladeXTemplate\Support\Arr::toCssStyles{$match[2]}\"";
                }
        ...
        return collect($attributes)
                ->map(function (string $value, string $attribute) use ($escapeBound) {
                    return $escapeBound && isset($this->boundAttributes[$attribute]) && $value !== 'true' && ! is_numeric($value)
                                ? "'{$attribute}' => \Yng\View\BladeXTemplate\View\Compilers\BladeCompiler::sanitizeComponentAttribute({$value})"
                                : "'{$attribute}' => {$value}";
                })
                ->implode(',');
    }
