...
use Yng\View\BladeXTemplate\View\Compilers\ComponentTagCompiler;
...
class DynamicComponent extends Component
{
     ...
     *
     * @var \Yng\View\BladeXTemplate\View\Compilers\BladeTagCompiler
     */
     ...
     *
     * @return \Yng\View\BladeXTemplate\Contracts\View\View|string
     */
    public function render()
    {
        $template = <<<'EOF'
<?php extract(collect($attributes->getAttributes())->mapWithKeys(function ($value, $key) { return [Yng\View\BladeXTemplate\Support\Str::camel(str_replace([':', '.'], ' ', $key)) => $value]; })->all(), EXTR_SKIP); ?>
{{ props }}
...
EOF;
        ...
        return function ($data) use ($template) {
            ...
            return str_replace(
                ...
                [
                    ...
                    $this->compileSlots($data['__yngphp_slots']),
                    '{{ $slot ?? "" }}',
                ],
                $template
            );
     ...
     *
     * @return \Yng\View\BladeXTemplate\View\Compilers\ComponentTagCompiler
     */
