...
class View implements ArrayAccess, Htmlable, ViewContract
{
     ...
     *
     * @var \Yng\View\BladeXTemplate\View\Factory
     */
    protected $factory;
     ...
     *
     * @var \Yng\View\BladeXTemplate\Contracts\View\Engine
     */
    protected $engine;
     ...
     *
     * @param  \Yng\View\BladeXTemplate\View\Factory  $factory
     * @param  \Yng\View\BladeXTemplate\Contracts\View\Engine  $engine
     * @param  string  $view
     * @param  string  $path
     * @param  mixed  $data
     * @return void
     ...
     * @return \Yng\View\BladeXTemplate\View\View
     *
