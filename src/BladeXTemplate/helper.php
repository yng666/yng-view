...
use Yng\View\BladeXTemplate\Support\HigherOrderTapProxy;
...
if (! function_exists('view')) {
     ...
     * @return \Yng\View\BladeXTemplate\Contracts\View\View|\Yng\View\BladeXTemplate\Contracts\View\Factory
     */
...
if (! function_exists('csrf_field')) {
    ...
    {
        return '<input type="hidden" name="' . $name . '" value="'. \Yng\Facade\Request::buildToken($name, $type) .'">';
    }
}
...
if (! function_exists('str')) {
     ...
     * @return \Yng\View\BladeXTemplate\Support\Stringable|mixed
     */
